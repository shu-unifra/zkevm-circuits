...
/// MAX_TXS
const MAX_TXS: usize = 4*4;
/// MAX_CALLDATA
const MAX_CALLDATA: usize = 512*4;
/// MAX_RWS
const MAX_RWS: usize = 5888*4;
/// MAX_BYTECODE
const MAX_BYTECODE: usize = 5000*4;
/// MAX_COPY_ROWS
const MAX_COPY_ROWS: usize = 5888*4;
/// MAX_EVM_ROWS
const MAX_EVM_ROWS: usize = 10000*4;
/// MAX_INNER_BLOCKS
pub const MAX_INNER_BLOCKS: usize = 64*4;
/// MAX_EXP_STEPS
const MAX_EXP_STEPS: usize = 1000*4;

const MAX_KECCAK_ROWS: usize = 10000*4;
